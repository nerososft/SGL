...
bool SpzModel::loadModel(const char *str) {
    ...
    for (size_t i = 0; i < header->numPoints; i++) {
        ...
        this->gaussianPoints[i].scale.z = decodeLog(file.scales[i].x, scaleMin.z, scaleMax.z);
        ...
        this->gaussianPoints[i].opacity.x = file.alphas[i].x;
        ...
        this->gaussianPoints[i].color.a = 1.0f;
    }
