...
VkResult PinchFilter::Apply(const std::shared_ptr<VkGPUContext> &gpuCtx,
    ...
    this->pinchFilterParams.imageSize.bytesPerLine = this->pinchFilterParams.imageSize.width * 4;
