...
VkResult CloudsFilter::Apply(const std::shared_ptr<VkGPUContext>& gpuCtx,
    ...
    this->cloudsFilterParams.imageSize.bytesPerLine = this->cloudsFilterParams.imageSize.width * 4;
