...
VkResult ZigzagFilter::Apply(const std::shared_ptr<VkGPUContext> &gpuCtx,
    ...
    this->zigzagFilterParams.imageSize.bytesPerLine = this->zigzagFilterParams.imageSize.width * 4;
