...
TransformFilter::Apply(const std::shared_ptr<VkGPUContext> &gpuCtx,
  ...
  this->transformFilterParams.imageSize.bytesPerLine =
      this->transformFilterParams.imageSize.width * 4;
  ...
  return BasicFilter::Apply(gpuCtx, "Transform", inputImageInfo[0].bufferSize,
...
void TransformFilter::Destroy() { BasicFilter::Destroy(); }
