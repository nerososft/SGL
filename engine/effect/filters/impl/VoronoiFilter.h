...
public:
  ...
  void SetGridSize(const uint32_t gridSize) {
    voronoiFilterParams.gridSize = gridSize;
  }

  void SetEnableEdge(const bool enableEdge) {
    voronoiFilterParams.enableEdge = enableEdge;
  }
