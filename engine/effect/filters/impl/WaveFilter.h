...
public:
    ...
    void SetWavelength(const int wavelength) { this->waveFilterParams.wavelength = wavelength; }
    void SetAmplitude(const int amplitude) { this->waveFilterParams.amplitude = amplitude; }
