...
public:
    ...
    void SetBlurRadius(const uint32_t radius) { this->focusBlurFilterParams.blurRadius = radius; }

    void SetCenterRadius(const uint32_t centerRadius) { this->focusBlurFilterParams.centerRadius = centerRadius; }

    void SetSharpness(const float sharpness) { this->focusBlurFilterParams.sharpness = sharpness; }
