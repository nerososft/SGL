...
VkResult DissolveBlender::Apply(const std::shared_ptr<VkGPUContext> &gpuCtx,
  ...
  this->dissolveBlenderParams.imageSize.baseImageChannels =
      baseImageInfo.channels;
  this->dissolveBlenderParams.imageSize.baseImageBytesPerLine =
      baseImageInfo.width * baseImageInfo.channels;
  this->dissolveBlenderParams.imageSize.blendImageWidth = blendImageInfo.width;
  this->dissolveBlenderParams.imageSize.blendImageHeight =
      blendImageInfo.height;
  this->dissolveBlenderParams.imageSize.blendImageChannels =
      blendImageInfo.channels;
  this->dissolveBlenderParams.imageSize.blendImageBytesPerLine =
  ...
  return DoApply(gpuCtx, "DissolveBlender", baseImageInfo, blendImageInfo,
                 outputBuffer, params);
}

void DissolveBlender::Destroy() { BaseBlender::Destroy(); }
