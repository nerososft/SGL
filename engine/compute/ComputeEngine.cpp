...
std::shared_ptr<IComputeGraphNode> ComputeEngine::ReLU(const std::shared_ptr<Matrix> &input,
...
std::shared_ptr<IComputeGraphNode> ComputeEngine::Sigmoid(const std::shared_ptr<Matrix> &input,
                                                          const std::shared_ptr<Matrix> &output) {
...
std::shared_ptr<IComputeGraphNode> ComputeEngine::Tanh(const std::shared_ptr<Matrix> &input,
                                                       const std::shared_ptr<Matrix> &output) {
...
std::shared_ptr<IComputeGraphNode> ComputeEngine::Softmax(const std::shared_ptr<Matrix> &input,
                                                          const std::shared_ptr<Matrix> &output) {
...
std::shared_ptr<IComputeGraphNode> ComputeEngine::GELU(const std::shared_ptr<Matrix> &input,
                                                       const std::shared_ptr<Matrix> &output) {
...
std::shared_ptr<IComputeGraphNode> ComputeEngine::SiLU(const std::shared_ptr<Matrix> &input,
                                                       const std::shared_ptr<Matrix> &output) {
...
std::shared_ptr<IComputeGraphNode> ComputeEngine::MatMul(const std::shared_ptr<Matrix> &mat1,
...
std::shared_ptr<IComputeGraphNode> ComputeEngine::RoPE(const uint32_t ropeTheta,
                                                       uint32_t m,
...
std::shared_ptr<IComputeGraphNode> ComputeEngine::RMSNorm(const std::shared_ptr<Matrix> &vectorInput,
                                                          const float scale,
                                                          const float bias,
                                                          const float epsilon,
                                                          const std::shared_ptr<Matrix> &vectorOutput) {
...
std::shared_ptr<IComputeGraphNode> ComputeEngine::LayerNorm(const std::shared_ptr<Matrix> &vectorInput,
...
std::shared_ptr<IComputeGraphNode> ComputeEngine::Split(const std::shared_ptr<Matrix> &vectorInput,
                                                        const uint64_t nums,
...
std::shared_ptr<IComputeGraphNode> ComputeEngine::Concat(const std::vector<std::shared_ptr<Matrix> > &inputVectors,
                                                         const std::shared_ptr<Matrix> &vectorOutput) {
...
std::shared_ptr<IComputeGraphNode> ComputeEngine::Add(const std::shared_ptr<Matrix> &inputVector1,
...
std::shared_ptr<IComputeGraphNode> ComputeEngine::Sum(const std::shared_ptr<Matrix> &inputVector1) {
...
std::shared_ptr<IComputeGraphNode> ComputeEngine::Sum(const std::shared_ptr<Matrix> &inputVector1, float *output) {
    const auto sumOp = std::make_shared<SumOperator>(inputVector1->GetBuffer());
    sumOperators.push_back(sumOp);
    sumOp->SetSum(output);
    const auto sumNode = sumOp->CreateComputeGraphNode();
...
std::shared_ptr<IComputeGraphNode> ComputeEngine::GatedSiLU(const std::shared_ptr<Matrix> &inputVector,
...
std::shared_ptr<IComputeGraphNode> ComputeEngine::RoPEAndMul(const uint32_t ropeTheta,
                                                             const uint32_t m,
                                                             const uint32_t n,
...
std::shared_ptr<IComputeGraphNode> ComputeEngine::RoPEDotProduct(const uint32_t ropeTheta,
                                                                 const uint32_t m,
                                                                 const uint32_t n,
                                                                 const std::shared_ptr<Matrix> &Q,
                                                                 const std::shared_ptr<Matrix> &K,
...
std::shared_ptr<IComputeGraphNode> ComputeEngine::Transpose(const std::shared_ptr<Matrix> &inputMatrix,
...
std::shared_ptr<IComputeGraphNode> ComputeEngine::LogSoftmax(const std::shared_ptr<Matrix> &input,
                                                             const std::shared_ptr<Matrix> &output) {
    const auto expSumOp = std::make_shared<ExpSumOperator>(input->GetBuffer());
    expSumOperators.push_back(expSumOp);
    const auto expSumNode = expSumOp->CreateComputeGraphNode();
