...
VkResult ColorPencilSketchFilter::Apply(
  ...
  this->colorPencilSketchFilterParams.imageSize.height =
  ...
  return BasicFilter::Apply(
      gpuCtx, "ColorPencilSketch", inputImageInfo[0].bufferSize,
...
void ColorPencilSketchFilter::Destroy() { BasicFilter::Destroy(); }
