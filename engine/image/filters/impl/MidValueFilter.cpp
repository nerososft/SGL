...
VkResult
MidValueFilter::Apply(const std::shared_ptr<VkGPUContext> &gpuCtx,
  ...
  this->midvalueFilterParams.imageSize.bytesPerLine =
      this->midvalueFilterParams.imageSize.width * 4;
  ...
  return BasicFilter::Apply(gpuCtx, "MidValue", inputImageInfo[0].bufferSize,
...
void MidValueFilter::Destroy() { BasicFilter::Destroy(); }
