...
MotionBlurFilter::Apply(const std::shared_ptr<VkGPUContext> &gpuCtx,
  ...
  this->motionBlurFilterParams.imageSize.bytesPerLine =
      this->motionBlurFilterParams.imageSize.width * 4;
  ...
  return BasicFilter::Apply(gpuCtx, "MotionBlur", inputImageInfo[0].bufferSize,
...
void MotionBlurFilter::Destroy() { BasicFilter::Destroy(); }
