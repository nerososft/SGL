...
VkResult
TwirlWarpFilter::Apply(const std::shared_ptr<VkGPUContext> &gpuCtx,
  ...
  this->twirlwarpFilterParams.imageSize.bytesPerLine =
      this->twirlwarpFilterParams.imageSize.width * 4;
  ...
  return BasicFilter::Apply(gpuCtx, "TwirlWarp", inputImageInfo[0].bufferSize,
...
void TwirlWarpFilter::Destroy() { BasicFilter::Destroy(); }
