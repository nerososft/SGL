...
WaveFilter::Apply(const std::shared_ptr<VkGPUContext> &gpuCtx,
  ...
  this->waveFilterParams.imageSize.bytesPerLine =
      this->waveFilterParams.imageSize.width * 4;
  ...
  return BasicFilter::Apply(gpuCtx, "Wave", inputImageInfo[0].bufferSize,
...
void WaveFilter::Destroy() { BasicFilter::Destroy(); }
