...
public:
  ...
  VkResult DoApply(const std::shared_ptr<VkGPUContext> &gpuCtx,
                   const std::string &name, const BlendImageInfo &baseImageInfo,
                   const BlendImageInfo &blendImageInfo, VkBuffer outputBuffer,
                   const BasicBlenderParams &blenderParams, uint32_t workGroupX,
