...
VkResult OverlayBlender::Apply(const std::shared_ptr<VkGPUContext> &gpuCtx,
  ...
  this->overlayBlenderParams.imageSize.baseImageChannels =
      baseImageInfo.channels;
  this->overlayBlenderParams.imageSize.baseImageBytesPerLine =
  ...
  this->overlayBlenderParams.imageSize.blendImageChannels =
      blendImageInfo.channels;
  this->overlayBlenderParams.imageSize.blendImageBytesPerLine =
  ...
  return DoApply(gpuCtx, "OverlayBlender", baseImageInfo, blendImageInfo,
                 outputBuffer, params);
}

void OverlayBlender::Destroy() { BaseBlender::Destroy(); }
