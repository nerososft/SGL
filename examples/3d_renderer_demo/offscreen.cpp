...
int main(int argc, char *argv[]) {
    ...
    renderer->SetOnLoadScene([](Renderer *rdr) -> bool {
            const std::vector<std::shared_ptr<Mesh> > models = ModelLoader::LoadModel(
                "../../../examples/3d_renderer_demo/assets/builtin.models/Helmet/DamagedHelmet.gltf");
    ...
    renderer->RenderFrameOffScreen("../../../examples/3d_renderer_demo/render_offscreen1.png");
    return 0;
}
