...
void effect_engine_main() {
    ...
    // filter->SetGreenFactor(0.587);
    // filter->SetBlueFactor(0.114);
    // effectEngine.Process("../../../examples/effect_demo/images/girl.png", "../../../examples/effect_demo/images/girl_gray.png", filter);

    // const auto filter = std::make_shared<GaussianBlurFilter>();
    // filter->SetRadius(300);
    // effectEngine.Process("../../../examples/effect_demo/images/girl.png", "../../../examples/effect_demo/images/girl_blur.png", filter);

    // const auto filter = std::make_shared<ChinesePaintFilter>();
    // effectEngine.Process("../../../examples/effect_demo/images/girl.png", "../../../examples/effect_demo/images/girl_chinese_paint.png", filter);

    // const auto filter = std::make_shared<ColorPencilSketchFilter>();
    // effectEngine.Process("../../../examples/effect_demo/images/girl.png", "../../../examples/effect_demo/images/girl_color_pencil_sketch.png", filter);
    ...
    // effectEngine.Process("../../../examples/effect_demo/images/girl.png", "../../../examples/effect_demo/images/girl_color_separation.png", filter);

    // const auto filter = std::make_shared<ScaleFilter>();
    // filter->SetTargetWidth(409);
    // filter->SetTargetHeight(613);
    // effectEngine.Process("../../../examples/effect_demo/images/girl.png", "../../../examples/effect_demo/images/girl_scale_down.png", 409, 613, filter);

    // const auto filter = std::make_shared<OldGaussianBlurFilter>();
    // filter->SetRadius(12);
    // effectEngine.Process("../../../examples/effect_demo/images/girl_scale_down.png", "../../../examples/effect_demo/images/girl_scale_down_blur.png", filter);

    // const auto filter = std::make_shared<ScaleFilter>();
    // filter->SetTargetWidth(4093);
    // filter->SetTargetHeight(6139);
    // effectEngine.Process("../../../examples/effect_demo/images/girl_scale_down_blur.png",
    //                      "../../../examples/effect_demo/images/girl_scale_up_blur.png", 4093, 6139, filter);
    ...
    // effectEngine.Process("../../../examples/effect_demo/images/girl.png", "../../../examples/effect_demo/images/girl_radial_blur.png", filter);
    ...
    // effectEngine.Process("../../../examples/effect_demo/images/colorful.png", "../../../examples/effect_demo/images/colorful_focus_blur.png", filter);

    // const auto filter = std::make_shared<SurfaceBlurFilter>();
    // filter->SetBlurRadius(60);
    // filter->SetThreshold(128);
    // effectEngine.Process("../../../examples/effect_demo/images/girl.png", "../../../examples/effect_demo/images/girl_surface_blur.png", filter);

    // const auto blender = std::make_shared<DissolveBlender>();
    // blender->SetDissolveFactor(0.5);
    // effectEngine.Process("../../../examples/effect_demo/images/girl.png",
    //                      "../../../examples/effect_demo/images/colorful.png",
    //                      500,
    //                      800,
    //                      "../../../examples/effect_demo/images/girl_colorful_dissolve.png", blender);
    ...
    //                      500,
    //                      800,
    //                      "../../../examples/effect_demo/images/girl_colorful_multiply.png", blender);
    ...
    //                      500,
    //                      800,
    //                      "../../../examples/effect_demo/images/girl_colorful_lighter.png", blender);
    //                      "../../../examples/effect_demo/images/girl_colorful_overlay.png", blender);
    ...
    // effectEngine.Process("../../../examples/effect_demo/images/colorful.png", "../../../examples/effect_demo/images/colorful_vibrance.png", filter);

    // const auto filter = std::make_shared<PaletteKnifeFilter>();
    // filter->SetRadius(10);
    // filter->SetQuantScale(5);
    // effectEngine.Process("../../../examples/effect_demo/images/colorful.png", "../../../examples/effect_demo/images/colorful_palette_knife.png", filter);

    // const auto filter = std::make_shared<NES8BitMosaicFilter>();
    // filter->SetBlockSize(64);
    // effectEngine.Process("../../../examples/effect_demo/images/girl.png", "../../../examples/effect_demo/images/girl_8bit.png", filter);

    // const auto filter = std::make_shared<ThresholdSplitFilter>();
    // filter->SetBright(10);
    // effectEngine.Process("../../../examples/effect_demo/images/girl.png", "../../../examples/effect_demo/images/girl_threshold.png", filter);

    // const auto filter = std::make_shared<VoronoiFilter>();
    // filter->SetGridSize(64);
    // filter->SetEnableEdge(true);
    // effectEngine.Process("../../../examples/effect_demo/images/colorful.png", "../../../examples/effect_demo/images/colorful_voronoi.png", filter);
    ...
    // effectEngine.Process("../../../examples/effect_demo/images/girl.png", "../../../examples/effect_demo/images/girl_fast_blur.png", filter);

    // const auto filter = std::make_shared<MedianFilter>();
    // filter->SetRadius(50);
    // effectEngine.Process("../../../examples/effect_demo/images/test.png", "../../../examples/effect_demo/images/test_median.png", filter);
    ...
    effectEngine.Process("../../../examples/effect_demo/images/girl.png",
                         "../../../examples/effect_demo/images/girl_transform.png", filter);
}
